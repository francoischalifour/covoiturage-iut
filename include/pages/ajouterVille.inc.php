...
if (empty($_POST['vil_nom'])) {
    ...
    <form action="#" method="post">
        <div class="row form-group">
            ...
            <div class="col-lg-10">
                <input type="text" placeholder="Nom de la ville" class="form-control" name="vil_nom" pattern="[a-zA-Z][a-zA-Z-]{2,20}" title="Le nom de la ville doit comporté au moins 3 caractères." required="required">
            </div>
        </div>
